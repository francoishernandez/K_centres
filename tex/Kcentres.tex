...
\caption{Rayon en fonction du nombre de points et du nombre de centres (Instances uniformes)}
\end{center}
\end{figure}
...
\caption{Rayon en fonction du nombre de points et du nombre de centres (10 clusters)}
\end{center}
\end{figure}
...
\caption{Rayon en fonction du nombre de points et du nombre de centres - Uniforme vs. Clusters}
\end{center}
\end{figure}
